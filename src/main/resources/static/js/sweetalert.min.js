    ...
    return function (t) {
        ...
        var s = function (t) {
            switch (t) {
                ...
                default: var n = t.charAt(0).toUpperCase() + t.slice(1);
            ...
            switch (t.length) {
                case 1: n[e.CANCEL_KEY] = Object.assign({
                    ...
                    break;
                case 2: n[e.CANCEL_KEY] = c(e.CANCEL_KEY, t[0]), n[e.CONFIRM_KEY] = c(e.CONFIRM_KEY, t[1]);
                    break;
        ...
        (function (t, e) {
            !function (t, n) {
                ...
                function o(t) {
                    ...
                    var s, c = 1, l = {
                    }, u = !1, f = t.document, d = Object.getPrototypeOf && Object.getPrototypeOf(t);
        ...
        function o(t, e) {
            ...
            for (var n = Object(t), o = 1;
                ...
                o++) {
                var r = arguments[o];
                if (void 0 !== r && null !== r) for (var i = Object.keys(Object(r)), a = 0, s = i.length;
                    a < s;
                    a++) {
